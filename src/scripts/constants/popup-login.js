const POPUP_LOGIN_CONTENT = `<div class="popup__container popup__container_margin-top_m">
                              <button
                              ...
                              >
                                <fieldset class="popup__fieldset">
                                  <legend class="popup__title popup__title_form">Вход</legend>
                                  ...
                                  <input
                                    ...
                                    pattern="(([a-z0-9]+((_|\.|-)[a-z0-9]+)+)|[a-z0-9]{2,})@[a-z0-9]{2,8}(\.[a-z]{2,8}){1,2}"
                                  ...
                                  <span class="popup__error popup__error_server form__error form__error_server">Неправильные почта или пароль</span>
                                  <button
                                    class="popup__button popup__button_type_login button form__button"
                                    type="submit"
                                    disabled
                                  >
                                    Войти
...
export default POPUP_LOGIN_CONTENT;
